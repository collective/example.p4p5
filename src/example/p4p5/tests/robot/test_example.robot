...
#
#  $ bin/test -s example.p4p5 -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src example.p4p5.testing.EXAMPLE_P4P5_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/example/p4p5/tests/robot/test_example.robot
#
